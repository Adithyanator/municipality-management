...
async function createWorkbook() {
  ...
  const tasksRaw = [
    ...
    [
      ...
      'No',
      'No',
      'Master traceability index setup',
    ],
    [
      'TASK-QA-002',
      'Documentation & QA',
  ...
  const kpis = [
    ...
    // New KPIs (Change 7)
    {
      ...
      valFormula: '=COUNTIFS(F16:F111, "<>Completed", M16:M111, "Yes")',
      cellLabel: 'M2',
      cellVal: 'M3',
      mergeLabel: 'M2:N2',
      mergeVal: 'M3:N4',
  ...
  const guideRows = [
    ...
    [
      ...
      "Go to your specific team task sheet (e.g. 'Frontend Tasks') and type the date in dd-mm-yyyy format in the 'Last Updated' column (Column J) whenever you change a task's status.",
    ],
    [
    ...
    [
      ...
      "Filter the Master Task List on 'Dashboard' by the 'Demo Critical?' column (Column M) = 'Yes'. These core features (Auth, Complaints, Attendance, Chatbot, etc.) must be completed first.",
    ],
  ];
  ...
  const destPath = path.join(
    ...
    'Adhi',
    'kottakkal',
    'Municipality_Project_Advanced_Kanban.xlsx'
  );
