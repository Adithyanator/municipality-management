...
module.exports = {
  ...
  'TASK-INF-004': {
    ...
    keywords: 'mongodb atlas setup, database clusters config, IP whitelists rules, connection string',
  ...
  'TASK-INF-006': {
    ...
    keywords: 'eslint config rules, code quality checks, linter automation scripts, code style configuration',
    ref: 'docs/02-System-Architecture/MASTER_ARCHITECTURE_v1.md'
  },
  'TASK-INF-007': {
    ...
    keywords: 'prettier configuration, code formatter scripts, editor styling setup, auto format guidelines',
    ref: 'docs/02-System-Architecture/MASTER_ARCHITECTURE_v1.md'
  },
  'TASK-INF-008': {
  ...
  'TASK-INF-009': {
    ...
    keywords: 'production deploy checklist, hosting environments config, CORS restrictions rules, launch plan',
    ref: 'docs/02-System-Architecture/MASTER_ARCHITECTURE_v1.md'
  },
  ...
  'TASK-DB-003': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose permissions model, route permission check, database seeding scripts, RBAC config',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-004': {
  ...
  'TASK-DB-005': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose complaint schema, geolocation parameters, image path string, input validations',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-006': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose assignment schema, staff reference checking, ticket lifecycle tracker, validation rule',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-007': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose file tracking schema, workflow timeline array, tracking code index, metadata config',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-008': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose feedback schema, rating verification range, ticket integrity check, constraint validation',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-009': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose attendance schema, biometric log keys, geolocation validations, consent tracker',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-010': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose notification schema, read status boolean, user notification indices, query limits',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-011': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose audit log schema, append only controls, immutable collection hooks, activity log',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-012': {
    ...
    tech: 'Node.js, MongoDB, Mongoose',
    keywords: 'mongoose chat history model, chatbot session logs, token metric keys, TTL database indexes',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-013': {
    ...
    keywords: 'unique database indexes, geospatial coordinate indexing, explain query plans, database tuning',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-014': {
    ...
    keywords: 'foreign key reference checks, schema validation rules, data relational consistency, database design',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-015': {
    ...
    keywords: 'mongoose regex validators, geolocation coordinate validator, input sanity checker, error handler',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  'TASK-DB-016': {
    ...
    keywords: 'explain collection scan checks, covered query matching, aggregation pipeline tuning, indexes debug',
    ref: 'docs/04-Database-Architecture/SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'
  },
  ...
  'TASK-BE-001': {
    ...
    keywords: 'express scaffold setup, helmet secure middleware, CORS restrictions setup, routing base config',
  ...
  'TASK-BE-002': {
    ...
    keywords: 'mongoose connection adapter, auto reconnect loop, db credentials hook, collection pool size',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-003': {
    ...
    keywords: 'environment variable checks, schema parser config, error crash loop, bootstrap validation',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-004': {
    ...
    keywords: 'user registration api, express login route, bcrypt hashing config, user models lookup',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-005': {
    ...
    keywords: 'jwt signature token, token payload mapping, token expiry check, signature validation',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-006': {
    ...
    keywords: 'refresh token api, secure cookie transport, token rotation logic, session refresh route',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-007': {
    ...
    keywords: 'logout controller api, token cookie clearing, session delete route, express cookie clear',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-008': {
    ...
    keywords: 'rbac validation middleware, endpoint permission check, resource authorization, jwt token mapping',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-009': {
    ...
    keywords: 'database audit log, backend logger middleware, write transaction logs, security track',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-010': {
    ...
    keywords: 'express error middleware, centralized error formats, stack trace mask, custom exception mapper',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-011': {
    ...
    keywords: 'request body validation, request schema filters, middleware request parser, input filter',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-012': {
    ...
    keywords: 'complaint endpoints crud, coordinates geo parsing, file upload paths, updates validation',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-013': {
    ...
    tech: 'Node.js, Express, Mongoose',
    keywords: 'public tracking api, file status details, workflow tracker controller, privacy mask filter',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-014': {
    ...
    tech: 'Node.js, Express, Mongoose',
    keywords: 'feedback rating router, compliance status validation, complaints database lock, double rating block',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-015': {
    ...
    tech: 'Node.js, Express, Mongoose',
    keywords: 'attendance tracking controller, punch checkin route, biometric consent checker, coordinates validations',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-016': {
    ...
    keywords: 'admin configuration routes, SLA settings update, database config variables, role allocation panel',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-017': {
    ...
    tech: 'Node.js, Express, Mongoose',
    keywords: 'notification alert router, user notification logs, alerts read status, in-app notification',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-018': {
    ...
    keywords: 'express rate limit, brute force protection, authentication route limit, api rate policy',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-019': {
    ...
    keywords: 'health check endpoint, mongoose database validation, system metrics logs, diagnostics route',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  'TASK-BE-020': {
    ...
    keywords: 'swagger ui integration, openapi schema files, api endpoints docs, backend router spec',
    ref: 'docs/05-API-Architecture/API_Architecture_DB_Aligned_v1.0.md'
  },
  ...
  'TASK-FE-002': {
    ...
    keywords: 'tailwindcss client setup, custom color layouts, theme palette map, stylesheet utility',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-003': {
    ...
    keywords: 'folder architecture layout, files layout organization, clean code pattern, modular structure',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-004': {
    ...
    keywords: 'global sidebar component, header navbar layouts, mobile drawer controls, desktop layout shell',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-005': {
    ...
    keywords: 'react router client, path route definitions, route routing manager, browser paths map',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-006': {
    ...
    keywords: 'client route guard, role check component, guest redirect route, route permission gate',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-007': {
    ...
    keywords: 'axios client config, api routing base, endpoint timeout handler, network connection check',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-008': {
    ...
    keywords: 'jwt request interceptor, token refresh hooks, axios token injector, unauthorized handler',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-009': {
    ...
    keywords: 'login layout ui, citizen registration form, input validation bounds, input error displays',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-010': {
    ...
    keywords: 'citizen portal interface, dashboard tracking view, tickets status table, citizen statistics widgets',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-011': {
    ...
    keywords: 'complaint submission layout, file attach validation, coordinates browser picker, form submittals',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-012': {
    ...
    keywords: 'file tracking timeline, search status lookup, processing steps progress, tracking stepper ui',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-013': {
    ...
    keywords: 'grievance feedback card, ratings scale component, feedback comment panel, ticket locking UI',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-014': {
    ...
    keywords: 'staff console layout, kanban board workspace, task status column, employee ticket picker',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-015': {
    ...
    keywords: 'webcam attendance interface, checkin punch layout, biometric consent tick, camera stream box',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-016': {
  ...
  'TASK-FE-017': {
    ...
    keywords: 'admin configuration panel, sla thresholds slider, user roles list, departments manager table',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-018': {
    ...
    keywords: 'notification toast popup, header dropdown console, alerts log template, notification status toggle',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-019': {
    ...
    keywords: 'reusable input components, customized button designs, modal popup wrapper, common asset styles',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-020': {
    ...
    keywords: 'mobile responsive debugging, responsive flex settings, mobile navigation menu, layout breaks',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-021': {
    ...
    keywords: 'integrate api connections, react page request, backend endpoint mapping, rest query controller',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-022': {
    ...
    keywords: 'react error boundary, react rendering recovery, application fallback layout, crash warning screens',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-023': {
    ...
    keywords: 'skeleton card loaders, page loading layout, shimmer CSS animations, data fetching wrapper',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FE-024': {
    ...
    keywords: 'user interface testing, mobile viewport simulation, client navigation checks, final design audit',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  ...
  'TASK-AI-001': {
    ...
    keywords: 'gemini api integration, ai service gateway, developer api keys, request parameters check',
  ...
  'TASK-AI-002': {
    ...
    keywords: 'prompt system instructions, gemini grounding prompts, RAG system prompt, prompt templates design',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-AI-003': {
    ...
    tech: 'Node.js, Express, Mongoose',
    keywords: 'chat api endpoint, express session router, chatbot request handlers, conversation log pipeline',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-AI-004': {
  ...
  'TASK-AI-005': {
    ...
    keywords: 'document validation algorithm, regex pattern matching, parsed metadata check, content validation',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-AI-006': {
    ...
    keywords: 'face landmarks extraction, distance matrix score, python image processing, biometric model matching',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-AI-007': {
    ...
    keywords: 'attendance punch service, python backend shell, biometric threshold config, checkin connector',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-AI-008': {
    ...
    keywords: 'far frr analysis, camera light test, biometric accuracy audit, validation summary log',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-AI-009': {
    ...
    keywords: 'chatbot response speed, context token caching, prompt length optimization, response latency reduction',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  ...
  'TASK-FR-001': {
    ...
    keywords: 'calibrate dataset configuration, test image assets, face snapshots array, git exclude rules',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-002': {
    ...
    keywords: 'refine biometric prototype, face verification thresholds, anti spoof validation, distance calculations',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-003': {
    ...
    keywords: 'webcam browser permissions, camera initialize check, browser support limits, stream errors log',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-004': {
    ...
    keywords: 'biometric checkin verify, camera punch test, workflow integration check, attendance logger',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-005': {
    ...
    keywords: 'spoofing attack tests, print photo reject, biometric vulnerability check, validation thresholds log',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-006': {
    ...
    keywords: 'cross browser camera, webcam compatibility table, browser camera exception, permission test log',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-007': {
    ...
    keywords: 'biometric overlay layout, camera frame wrapper, mobile webcam responsive, UI layout reviews',
    ref: 'docs/06-UI-Architecture/Frontend_Architecture_Final_Merged_Updated.pdf'
  },
  'TASK-FR-008': {
    ...
    keywords: 'biometric end to end, attendance integration audit, transaction updates validation, db updates trace',
    ref: 'docs/07-AI-Architecture/AI_Architecture_Final_Submission_Updated.pdf'
  },
  'TASK-FR-009': {
    ...
    keywords: 'biometric consent validations, webcam consent check, block scanner logic, consent gate test',
  ...
  'TASK-QA-001': {
    ...
    keywords: 'rtm document structure, srs traceability mapping, specification validation index, quality metrics',
  ...
  'TASK-QA-002': {
    ...
    keywords: 'manual test script, user action validations, expected results table, test case layout',
    ref: 'docs/01-SRS/SRS_AI_Powered_Municipality_Management_Portal_Updated.docx'
  },
  'TASK-QA-003': {
    ...
    keywords: 'uat checklist templates, user acceptance verification, dashboard validation logs, client signup signoff',
    ref: 'docs/01-SRS/SRS_AI_Powered_Municipality_Management_Portal_Updated.docx'
  },
  'TASK-QA-004': {
    ...
    keywords: 'project documents compile, architecture review, compliance check report, version audit logs',
    ref: 'docs/01-SRS/SRS_AI_Powered_Municipality_Management_Portal_Updated.docx'
  },
  'TASK-QA-005': {
    ...
    keywords: 'security check audit, password hashing config, jwt validation gate, signoff compliance tracker',
    ref: 'docs/03-Security-Architecture/Security_Access_Control_Architecture_Document.md'
  },
  'TASK-QA-006': {
  ...
  'TASK-QA-008': {
    ...
    keywords: 'developer setup instructions, backend deploy guide, database settings doc, folder structures map',
    ref: 'docs/01-SRS/SRS_AI_Powered_Municipality_Management_Portal_Updated.docx'
  },
  'TASK-QA-009': {
    ...
    keywords: 'municipality handoff guide, credential keys rotation, administrator logins audit, handover manuals template',
