...
async function compare() {
  ...
  for (let r = 16; r <= 111; r++) {
    ...
    excelTasks.push({ r, taskId, taskName, assignedTo, priority, status, day, dep, remarks, demoCritical });
  }
  ...
  if (diffs === 0) {
    console.log('Success: All task IDs match exactly between existing Excel file and raw generator array!');
  } else {
