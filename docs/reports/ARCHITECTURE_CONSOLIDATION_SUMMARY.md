...
5. **[ARCHITECTURE_FREEZE_v1.md](file:///d:/Adhi/kottakkal/docs/09-Handover-Documents/ARCHITECTURE_FREEZE_v1.md):** Formally freezes the version 1.0 technical baselines with a status of _Approved for Development, but with Open Issues tracked separately_.
