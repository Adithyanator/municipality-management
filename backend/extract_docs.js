...
async function main() {
    ...
    const docs = {
        srs: path.join(baseDir, 'docs', 'srs', 'SRS_AI_Powered_Municipality_Management_Portal_Updated.docx'),
        database: path.join(baseDir, 'docs', '04-Database-Architecture', 'SmartCity_DB_Architecture_v4.0_AI_Extension_Updated.md'),
        security: path.join(baseDir, 'docs', '03-Security-Architecture', 'Security_Access_Control_Architecture_Document.md'),
        ui: path.join(baseDir, 'docs', '06-UI-Architecture', 'Frontend_Architecture_Final_Merged_Updated.pdf'),
        ai: path.join(baseDir, 'docs', '07-AI-Architecture', 'AI_Architecture_Final_Submission_Updated.pdf')
    };
